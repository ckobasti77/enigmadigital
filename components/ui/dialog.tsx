...
function DialogClose({
  ...
  return (
    <DialogPrimitive.Close
      ...
      className={cn(
        "absolute right-4 top-4 rounded-sm text-text-muted opacity-70 transition-opacity hover:opacity-100 hover:text-foreground focus:outline-hidden disabled:pointer-events-none",
        className,
      )}
      {...props}
    >
