...
Izmereno skriptom `scripts/dna-inventory.mjs` nad `app/**` i `components/**` (302 fajlova). Datum: 2026-09-10.

## 1. Boje — tokeni koji se STVARNO koriste

Deklarisano u `@theme inline`: 73 tokena boja. Korišćeno: 44.

| token | upotreba |
|---|---|
| `text-muted` | 1771 · alfa koraci: 20, 40, 45, 50, 60, 70, 80 |
| `foreground` | 1098 · alfa koraci: 10, 45, 50, 60, 80, 90 |
| `accent-400` | 796 · alfa koraci: 5, 10, 15, 20, 25, 30, 40, 50, 80, [0.06], [0.03], 60, 70, [0.04], 90 |
| `line` | 736 · alfa koraci: 40, 50, 60, 70 |
| `surface-raised` | 486 · alfa koraci: 10, 20, 30, 40, 50, 60, 70, 80, 95 |
| `line-soft` | 468 · alfa koraci: 50, 60 |
| `danger` | 383 · alfa koraci: 5, 10, 15, 20, 25, 30, 40, 60, 70, 80, 90 |
| `warning` | 345 · alfa koraci: 5, 10, 15, 20, 25, 30, 40, 50, 60, 80, 90 |
| `surface` | 330 · alfa koraci: 20, 30, 40, 50, 60, 70, 80, 85, 90, 95 |
| `success` | 257 · alfa koraci: 5, 10, 15, 20, 30, 40, 80, 90 |
| `muted-foreground` | 160 · alfa koraci: 30, 50, 70 |
| `text-secondary` | 118 |
| `line-strong` | 57 |
...
| `popover` | 10 |
| `temp-hot` | 10 · alfa koraci: 40, 50 |
| `chart-2` | 9 · alfa koraci: 10, 40 |
| `temp-warm` | 8 · alfa koraci: 40, 50 |
...
Deklarisani, a nekorišćeni: `bg-800`, `surface-light`, `surface-light-muted`, `line-control`, `text-on-light`, `text-on-light-secondary`, `text-on-light-muted`, `accent-700`, `accent-glow`, `chart-3`, `chart-4`, `chart-5`, `chart-6`, `chart-grid`, `temp-nova`, `temp-cold`, `temp-nova-bg`, `temp-cold-bg`, `strength-low`, `strength-mid`, `strength-high`, `card`, `sidebar`, `sidebar-foreground`, `sidebar-primary`, `sidebar-primary-foreground`, `sidebar-accent-foreground`, `sidebar-border`, `sidebar-ring`.
...
| `text-white` | 6 | app/deletion-status/page.tsx, components/app/instagram/instagram-stories.tsx, components/app/instagram/publish-preview.tsx |
...
Deklarisane veličine u `@theme`: `primary`, `secondary`, `muted`, `inverse`, `on-light`, `on-light-secondary`, `on-light-muted`, `secondary-vibrant`, `muted-vibrant`, `meta`, `meta--line-height`, `meta--letter-spacing`, `meta--font-weight`, `ui`, `ui--line-height`, `ui--letter-spacing`, `ui--font-weight`, `copy`, `copy--line-height`, `copy--letter-spacing`, `copy--font-weight`, `title`, `title--line-height`, `title--letter-spacing`, `title--font-weight`, `metric`, `metric--line-height`, `metric--letter-spacing`, `metric--font-weight`, `display`, `display--line-height`, `display--letter-spacing`, `display--font-weight`, `h1`, `h1--line-height`, `h1--letter-spacing`, `h1--font-weight`, `h2`, `h2--line-height`, `h2--letter-spacing`, `h2--font-weight`, `body`, `body--line-height`, `body--letter-spacing`, `body--font-weight`, `small`, `small--line-height`, `small--letter-spacing`, `small--font-weight`, `micro`, `micro--line-height`, `micro--letter-spacing`, `micro--font-weight`, `xs`, `xs--line-height`, `xs--letter-spacing`, `sm`, `sm--line-height`, `sm--letter-spacing`, `base`, `base--line-height`, `base--letter-spacing`, `lg`, `lg--line-height`, `lg--letter-spacing`, `xl`, `xl--line-height`, `xl--letter-spacing`, `2xl`, `2xl--line-height`, `2xl--letter-spacing`, `3xl`, `3xl--line-height`, `3xl--letter-spacing`, `4xl`, `4xl--line-height`, `4xl--letter-spacing`, `5xl`, `5xl--line-height`, `5xl--letter-spacing`, `6xl`, `6xl--line-height`, `6xl--letter-spacing`.
...
`tabular-nums` kao klasa: 326 mesta (brojevi bez nje se ne mogu izbrojati grep-om).
...
| `3 (12px, mreža 4)` | 910 |
| `1 (4px, mreža 4)` | 793 |
| `1.5 (6px, mreža van)` | 713 |
| `4 (16px, mreža 8)` | 667 |
| `2.5 (10px, mreža van)` | 400 |
| `0.5 (2px, mreža van)` | 383 |
| `5 (20px, mreža 4)` | 291 |
| `6 (24px, mreža 8)` | 212 |
| `0 (0px, mreža 8)` | 187 |
| `8 (32px, mreža 8)` | 130 |
...
Ukupno 6123 razmaka; 3672 (60 %) NIJE na mreži od 8 px.
...
- **Čip (inline-flex + rounded + border + px + sitan tekst)**: 77 različitih recepata za 92 upotreba
- **Kartica (rounded-xl + bg-card/bg-surface)**: 56 različitih recepata za 93 upotreba
- **Natpis pločice (heading-caps + text-micro)**: 18 različitih recepata za 61 upotreba
- **Prazno stanje (centrirano, veliki vertikalni razmak)**: 22 različitih recepata za 30 upotreba
